...
- 薄い鍋には**追加ベースが必要**
- 残量だけ欲しいとき、水で利益を取るか、ベースで品質を守るかを選ぶ
...
**プレイヤーが選ぶ**：断るか、薄めて出すか。水もベースも尽きていれば断るしかない。
断れば今日の売上が減る。薄めて出せば売上は入るが評価が下がる。
**今日を取るか、明日を取るか**の選択。

...
| 区画名 ― 屋号 | 扱うもの |
|---|---|
| 第一食肉棟 ― 張記肉類加工 | 骨と大根のベース、モツ、軟骨、すじ肉、切り落とし |
| 青果第三通路 ― 永順青果 | 冬瓜、大根、苦瓜、香草、規格外野菜 |
...
- **張記肉類加工**：Day1「いつもの二袋を取っておいた」が自然に成立する店。
  ...
  Day1台本の老張のDM（「骨と大根、取っといた。遅れるなよ」）と一致する。
...
※ Day1 台本（day1_events.gd）の「骨と大根を受け取った」というテキストは
「鶏骨と手羽端を受け取った」等に修正が必要（未対応）。
...
| 具の軸 | 求めているもの | 具材例 |
|--------|--------------|--------|
| `FILLING`／腹持ち | 空腹を長く抑えたい | 米麺、芋団子、餃子皮、パン団子 |
| `POWER`／力 | 疲労時に肉気や栄養が欲しい | モツ、くず肉団子、魚つみれ、血豆腐 |
| `GENTLE`／いたわり | 胃・喉・歯に負担をかけたくない | 豆腐、冬瓜、大根、煮崩した葉物 |
